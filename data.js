// =========================================================================
// BASE DE DONNàƒâ€°ES DES PERFORMANCES GAZELLE (SA 342 M1)
// =========================================================================
...
// 
// POUR AJOUTER UNE TOUTE NOUVELLE CATàƒâ€°GORIE (Ex: Masse max au dàƒÂ©collage) :
// Copiez-collez un bloc entier (ex: de "HES_ARME": { ... } ) et changez :
// - type: "Identifiant court (ex: MMD)"
// - typeLabel: "Nom qui apparaàƒÂ®tra dans le 1er menu dàƒÂ©roulant"
// - configLabel: "Nom qui apparaàƒÂ®tra dans le 2àƒÂ¨me menu dàƒÂ©roulant"
// - xAxisLabel et yAxisLabel : Les titres des axes (si besoin de les changer)

// =========================================================================
// BASE DE DONNàƒâ€°ES DE LA FLOTTE
// =========================================================================
const fleetDatabase = {
...
// SCàƒâ€°NARIOS DE VOL
// =========================================================================
// Utilisez "SUFFIX" dans la liste des abaques pour qu'il soit remplacàƒÂ© par
// la configuration de la machine (_ARME ou _LISSE)
const scenariosDatabase = {
    "VOLTAC": {
        label: "Vol Tactique",
        charts: ["TAC_SUFFIX"] // Sera remplacàƒÂ© par TAC_ARME ou TAC_LISSE
    },
    "MONTAGNE": {
        label: "Vol Montagne",
        charts: ["HES_SUFFIX", "DES_SUFFIX"] // Sera remplacàƒÂ© par HES_ARME, DES_ARME...
    }
};
...
const chartsDatabase = {
    ...
    "HES_ARME": {
        ...
        configLabel: "ArmàƒÂ© (4 HOT, Viviane)",
...
const panneau7Alpha = [
    ...
    { id: 'GENE', label: 'GENE', color: 'amber', title: 'Panne Génératrice',
      htmlContent: `<h2 class='text-2xl font-bold text-amber-600 mb-4'>GENE - PANNE Gà‰Nà‰RATRICE</h2>
    ...
    { id: 'BAT', label: 'BAT.', color: 'amber', title: 'Batterie Isolée',
      htmlContent: `<h2 class='text-2xl font-bold text-amber-600 mb-4'>BAT - BATTERIE DISJONCTà‰E</h2>
    ...
    { id: 'FILT', label: 'FILT.', color: 'amber', title: 'Filtre Colmaté',
      htmlContent: `<h2 class='text-2xl font-bold text-amber-600 mb-4'>FILT - FILTRE COLMATà‰</h2>
...
const autresPannes = [
    { id: 'AUTOROTATION', title: 'Autorotation (Perte complète de puissance)', 
      htmlContent: `<h2 class='text-2xl font-bold text-slate-800 mb-4 border-b pb-2'>AUTOROTATION</h2>
                    ...
                    <ol class='list-decimal pl-5 space-y-2'>
                        ...
                        <li>Contrà´ler la vitesse (Vi = 100 à  110 km/h conseillée).</li>
    ...
    { id: 'PANNE_GTM_VOL', title: 'Arràªt du GTM en vol (Panne totale)', 
      htmlContent: `<h2 class='text-2xl font-bold text-slate-800 mb-4 border-b pb-2'>ARRàŠT DU G.T.M EN VOL</h2>
                    <p class='mb-4 text-slate-600'><b>Symptà´mes :</b> Fuselage tourne (légèrement) à  droite. "ALARM" puis "H.MOT" et "H.RAL" s'allument. La vitesse rotor diminue.</p>
                    ...
                    <ul class='list-disc pl-5 space-y-2'>
                        <li>Robinet coupe-feu <b>FERMà‰</b>.</li>
    ...
    { id: 'FONCT_ANORMAL_REGUL', title: 'Fonctionnement anormal du régulateur', 
      htmlContent: `<h2 class='text-2xl font-bold text-slate-800 mb-4 border-b pb-2'>Rà‰GULATEUR ANORMAL</h2>
                    ...
                    <p class='mt-4'><b>Vol avec régulateur hors circuit :</b> Croisière à  42.500 tr/mn environ et pas de l'ordre de 7,2Â°. Effectuer une approche glissée ou une autorotation selon l'équipage.</p>` },
    ...
    { id: 'FUMEE_CABINE', title: 'Fumée dans la cabine', 
      htmlContent: `<h2 class='text-2xl font-bold text-slate-800 mb-4 border-b pb-2'>FUMà‰E EN CABINE</h2>
                    ...
                    <ol class='list-decimal pl-5 space-y-2'>
                        ...
                        <li>Ventiler la cabine en ouvrant les fenàªtres coulissantes.</li>
                        ...
                        <li>Laisser l'équipement en cause sur arràªt.</li>
                    </ol>` },
    { id: 'ROTOR_ANTI_COUPLE', title: 'Panne du rotor anti-couple', 
      htmlContent: `<h2 class='text-2xl font-bold text-slate-800 mb-4 border-b pb-2'>PANNE ROTOR ANTI-COUPLE (RAC)</h2>
                    ...
                    <ul class='list-disc pl-5 space-y-1'>
                        ...
                        <li>Augmenter la vitesse, contrà´ler le cap par le roulis.</li>
    ...
    { id: 'INCIDENT_CMDE_VOL', title: 'Incidents commandes de vol / Servo-commandes', 
      htmlContent: `<h2 class='text-2xl font-bold text-slate-800 mb-4 border-b pb-2'>INCIDENT COMMANDES DE VOL</h2>
                    <p class='mb-4'><b>Symptà´me :</b> Durcissement des commandes de vol (sans allumage BP.HY).</p>
                    <p class='mb-2 font-bold'>Action Pilote :</p>
                    <ul class='list-disc pl-5 space-y-1'>
    ...
    { id: 'PANNE_COUPLEMETRE', title: 'Panne de couplemètre', 
      htmlContent: `<h2 class='text-2xl font-bold text-slate-800 mb-4 border-b pb-2'>PANNE COUPLEMàˆTRE</h2>
                    <p class='mb-2 font-bold'>Action Pilote :</p>
                    <ul class='list-disc pl-5 space-y-1'>
...
const torqueLimits = {
    ...
    TUYERE_DEC: [
        ...
        [100, 100, 100, 100, 100, 100, 100, 100, 100, 100],
        [100, 100, 100, 100, 100, 100, 100, 100, 100, 100],
        [100, 100, 100, 100, 100, 100, 100, 100, 100, null],
    ...
    TUYERE_CONT: [
        ...
        [100, 100, 100, 100, 100, 100, 100, 100, 95, null],
        [100, 100, 100, 100, 100, 100, 100, 92, null, null],
        [100, 100, 100, 100, 100, 97, 88, 81, null, null],
        [100, 100, 100, 97, 91, 85, 78, null, null, null]
    ],
    FAS_DEC: [
        [100, 100, 100, 100, 100, 100, 100, 100, 100, 100],
        [100, 100, 100, 100, 100, 100, 100, 100, 100, 96],
        [100, 100, 100, 100, 100, 100, 100, 100, 95, null],
        [100, 100, 100, 100, 100, 100, 100, 93, null, null],
        [100, 100, 100, 100, 100, 97, 90, 83, null, null],
        [100, 100, 100, 97, 91, 85, 79, null, null, null]
    ],
    FAS_CONT: [
        [100, 100, 100, 100, 100, 100, 100, 100, 100, 100],
        [100, 100, 100, 100, 100, 95, 85, null, null, null],
        [100, 100, 100, 100, 100, 93, 84, null, null, null],
        [100, 100, 100, 99, 90, 82, null, null, null, null],
        [100, 100, 94, 87, 80, 73, null, null, null, null],
        [100, 99, 94, 88, 82, 77, 70, null, null, null]
    ]
};
...
// ==========================================================================
// DONNà‰ES DE CENTRAGE (BRAS DE LEVIER)
// ==========================================================================
const cgData = {
    leverArms: {
        PCB: 1.44,
    ...
    envelope: {
        x: [2.80, 3.00, 3.00, 2.83, 2.80, 2.80],
        y: [1400, 1400, 2100, 2100, 1850, 1400]
    }
};
